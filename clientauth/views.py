...
def register (requested):
    ...
    mycursor.execute("INSERT INTO Student (Name, Totmarks, City, Email, Passwd) VALUES (%s, %s, %s, %s, %s )", (SName, Total_Marks, City, Email, Passwd))
    db.commit()
    finallst = { "POST": "The below data has been inserted.", "Student Name": SName, "Total Marks": Total_Marks, "City": City, "Email": Email, "Passwd": Passwd }
